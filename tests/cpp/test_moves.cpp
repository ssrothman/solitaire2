...
void test_moves(){
    ...
    REQUIRE(move1.amount() == 1);

    MoveType move2(Location::Waste, Location::Foundation);
    ...
    REQUIRE(move4.amount() == 1);

    MoveType move5(Location::Waste, Location::Stock);
    ...
    REQUIRE(move5.source_index() == 0);
    REQUIRE(move5.target_index() == 0);
    REQUIRE(move5.amount() == 1);


    MoveType move6(Location::Stock, Location::Waste);
    ...
    REQUIRE(move6.source_index() == 0);
    REQUIRE(move6.target_index() == 0);
    REQUIRE(move6.amount() == 1);

    MoveType move7(Location::Tableau, Location::Tableau, 2, 1, 3);
    REQUIRE(move7.source() == Location::Tableau);
    REQUIRE(move7.target() == Location::Tableau);
    REQUIRE(move7.type() == static_cast<uint8_t>(MoveKind::TableauToTableau));
    REQUIRE(move7.source_index() == 2);
    REQUIRE(move7.target_index() == 1);
    REQUIRE(move7.amount() == 3);

    MoveType move8(Location::Tableau, Location::Tableau, 3, 5, 11);
    REQUIRE(move8.source() == Location::Tableau);
    REQUIRE(move8.target() == Location::Tableau);
    REQUIRE(move8.type() == static_cast<uint8_t>(MoveKind::TableauToTableau));
    REQUIRE(move8.source_index() == 3);
    REQUIRE(move8.target_index() == 5);
    REQUIRE(move8.amount() == 11);
